...
ax2.set_xticklabels(ft_ranking['GoalDifference'], ha='left')
...
# Create the secondary axis (top axis)
ax2 = ax1.twiny()
ax2.set_xlim(ax1.get_xlim()) 
ax2.set_xticks(ax1.get_xticks()) 
ax2.set_xticklabels(ht_ranking['GoalDifference'], rotation_mode='anchor') 
plt.show()
```
### Discussion
